...
class SettingsPageEnhanced extends StatefulWidget {
  const SettingsPageEnhanced({super.key});

  @override
  State<SettingsPageEnhanced> createState() => _SettingsPageEnhancedState();
}

class _SettingsPageEnhancedState extends State<SettingsPageEnhanced> {
