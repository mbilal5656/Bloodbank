...
class _BloodInventoryPageState extends State<BloodInventoryPage> {
  ...
  Widget _buildInventoryGrid() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: currentTheme.surfaceColor.withOpacity(0.1),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: currentTheme.secondaryColor.withOpacity(0.3)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  Widget _buildStatCard({
    ...
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: currentTheme.surfaceColor.withOpacity(0.05),
        borderRadius: BorderRadius.circular(12),
